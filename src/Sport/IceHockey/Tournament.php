...
final class Tournament extends BroadAgeApiClient {
    ...
    protected $baseURL = '/icehockey/tournament/';
     ...
     * @link https://www.broadage.com/developers/ice-hockey-api/tournament-list
     ...
     * @link https://www.broadage.com/developers/ice-hockey-api/tournament-info
     * @return object | array | string
     * @throws ApiRequestException
     ...
     * @link https://www.broadage.com/developers/ice-hockey-api/tournament-teams
     * @return object | array | string
     * @throws ApiRequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/ice-hockey-api/tournament-fixture
     * @return object | array | string
     * @throws ApiRequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/ice-hockey-api/tournament-standings
     * @return object | array | string
     * @throws ApiRequestException
     * @throws InvalidArgumentException
     */
