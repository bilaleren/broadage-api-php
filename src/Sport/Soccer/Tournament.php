...
final class Tournament extends BroadAgeApiClient
{
    ...
    protected $baseURL = '/soccer/tournament/';
     ...
     * @link https://www.broadage.com/developers/soccer-api/tournament-list
     * @return Response
     ...
     * @link https://www.broadage.com/developers/soccer-api/tournament-info
     * @return Response
     * @throws RequestException
     ...
     * @link https://www.broadage.com/developers/soccer-api/tournament-teams
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/soccer-api/tournament-fixture
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/soccer-api/tournament-standings
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
