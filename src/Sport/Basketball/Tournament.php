...
final class Tournament extends BroadAgeApiClient
{
    ...
    protected $baseURL = '/basketball/tournament/';
     ...
     * @link https://www.broadage.com/developers/basketball-api/tournament-list
     * @return Response
     ...
     * @link https://www.broadage.com/developers/basketball-api/tournament-info
     * @return Response
     * @throws RequestException
     ...
     * @link https://www.broadage.com/developers/basketball-api/tournament-teams
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/basketball-api/tournament-fixture
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
     ...
     * @link https://www.broadage.com/developers/basketball-api/tournament-standings
     * @return Response
     * @throws RequestException
     * @throws InvalidArgumentException
     */
