...
final class MatchList extends BroadAgeApiClient {
     ...
     * @link https://www.broadage.com/developers/basketball-api/match-list-all
     ...
     * @link https://www.broadage.com/developers/basketball-api/match-list-scheduled
     * @return object | array | string
     * @throws ApiRequestException
     */
     ...
     * @link https://www.broadage.com/developers/basketball-api/match-list-live
     * @return object | array | string
     * @throws ApiRequestException
     */
     ...
     * @link https://www.broadage.com/developers/basketball-api/match-list-results
     * @return object | array | string
     * @throws ApiRequestException
     */
